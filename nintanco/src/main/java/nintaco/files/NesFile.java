...
public class NesFile implements CartFile, Serializable, Cloneable {
  ...
  public static interface CpuPpuTiming {
    ...
    static TVSystem toTVSystem(final int cpuPpuTiming) {
      switch(cpuPpuTiming) {
        case PAL:   return TVSystem.PAL;
        case DENDY: return TVSystem.Dendy;
        default:    return TVSystem.NTSC;
      }
    }
  ...
  public static interface ExtendedConsole {
  ...
  public static interface DefaultExpansionDevice {
    ...
    int STANDARD_CONTROLLERS                         = 0x00;
    int FAMICOM_CONTROLLERS_WITH_MICROPHONE          = 0x01;
    ...
    String[] NAMES = {
      "Standard controllers",                         // 00
      "Famicom controllers with microphone",          // 01
    ...
    static int toCartDevice(final int defaultExpansionDevice) {
      switch(defaultExpansionDevice) {
        ...
        case FAMICOM_CONTROLLERS_WITH_MICROPHONE:
  ...
  @Override public int[] getPrgROM() {
    return prgROM;
  }

  @Override public int[] getChrROM() {
    return chrROM;
  }
  
  @Override public boolean isTrainerPresent() {
    return trainerPresent;
  }
  
  @Override public int getTrainerSize() {
    return trainer.length;
  }
  
  @Override public int[] getTrainer() {
    return trainer;
  }

  @Override public int getMapperNumber() {
    return mapperNumber;
  }
  ...
  @Override public int getSubmapperNumber() {
  ...
  @Override public int getMirroring() {
    return mirroring;
  }
  ...
  @Override public int getChrRamSize() {
    return chrRamSize;
  }
  ...
  @Override public TVSystem getTvSystem() {
  ...
  @Override public int getVsHardware() {
    return vsHardware;
  }

  @Override public Cart getCart() {
    return cart;
  }

  @Override public VsGame getVsGame() {
    return vsGame;
  }

  @Override public boolean isChrRamPresent() {
    return chrRamPresent;
  }

  @Override public boolean isNonVolatilePrgRamPresent() {
  ...
  @Override public boolean isVsSystem() {
  ...
  @Override public boolean isVsUniSystem() {
  ...
  @Override public String getEntryFileName() {
    return entryFileName;
  }

  @Override public String getArchiveFileName() {
  ...
  @Override public int getFileCRC() {
    return fileCRC;
  }
  ...
  @Override public int getPrgRomLength() {
    return prgRomLength;
  }

  @Override public int getChrRomLength() {
    return chrRomLength;
  }
  ...
  @Override public int[] getFileContents() {
