...
public class Constants {
    ...
    public static final int generationTopNumber = 5; // how many top networks per generation to calculate stats for
    ...
    public static final double addNodeChance = 1.5; // chance to add a node that splits a connection in two
    public static final double mutateWeightsChance = 0.45; // chance to select an individual network for weight mutations
    ...
    public static final double enableChance = 0.4; // chance to enable a random connection
